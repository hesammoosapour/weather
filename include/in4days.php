<?php $status =  $data ['list']['4']['weather']['0']['main'];
if($status == 'Clouds') $status = 'ابری';
if($status == 'Rain') $status = 'بارانی';
if($status == 'Clear') $status = 'افتابی';
?>

<?php $in4days = "   <p style='float:right'>در 4 روز اینده :</p>
...
<tr>
    <td style='color: #005cbf'>".$data ['list']['4']['temp']['day']."</td>
    <td style='color: #005cbf'>".$data ['list']['4']['temp']['night']."</td>

    <td style='color: #6f42c1'>".$data ['list']['4']['temp']['eve']."</td>
    <td style='color: #491217'>".$data ['list']['4']['temp']['morn']."</td>
    <td style='color:#1c7431;'>".$status."</td>
    <td style='color: #20c997'>".$data ['list']['4']['speed']."</td>
    <td style='color: #fd7e14'>".$data ['list']['4']['deg']."</td>
